...
def main():
    ...
    raw_url = "https://web.archive.org/web/20210723223536fw_/http://vo-para.birdzberth.com/circle_list.html"
    ...
    for row in table_rows:
        ...
        circle_url = sanitize_string(col_tags[3].get_text(strip=True))
        if circle_url == "http://":
            circle_url = None
